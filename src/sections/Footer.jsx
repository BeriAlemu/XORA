...
function Footer(){
        return(
            <footer>
                <div className="containet py-10">
                    <div className="flex w-full max-md:flex-col">
                        <div className="small-compact flex flex-1 flex-wrap items-center justify-center gap-5 ">
                            <p className="opacity-70 max-md:pb-3"> copyright, bruh 2020</p>
                        </div>
                        ...
                        <ul className="flex flex-1 justify-center gap-3 max-md:mt-10 md:justify-end md:pr-20 ">
